...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.$http.get("/api/questions/".concat(this.qid)).then(function (r) {
      ...
      if (_this.question.is_pay) {
        _this.$http.get("/api/questions/".concat(_this.qid, "/advice")).then(function (r) {
          _this.advice = r.data.data;
        });
      }
    });
  },
