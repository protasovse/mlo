...
var _default = {
  ...
  methods: {
    ...
    request_and_load_answers: function request_and_load_answers() {
      ...
      this.$http.get("/api/question/".concat(this.qid, "/answers")).then(function (r) {
        _this2.count_answ = {};
    ...
    save: function save(upload_name) {
      ...
      this.put("/api/question/".concat(this.qid, "/answers"), data, function (r) {
