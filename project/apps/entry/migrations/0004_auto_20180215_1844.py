# Generated by Django 2.0 on 2018-02-15 15:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='question',
            name='is_pay',
            field=models.BooleanField(default=False, verbose_name='Платный вопрос'),
        ),
        migrations.AddField(
            model_name='consult',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.fields.NOT_PROVIDED, related_name='consult', to='entry.Question'),
        ),
        migrations.AddField(
            model_name='consult',
            name='state',
            field=models.ForeignKey(default=1, on_delete=django.db.models.fields.NOT_PROVIDED, to='entry.ConsultState', verbose_name='Текущее состояние'),
        ),
    ]
